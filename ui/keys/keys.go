...
var Keys = KeyMap{
	...
	PageDown:      key.NewBinding(key.WithKeys("ctrl+d", "ctrl+j", "ctrl+n"), key.WithHelp("Ctrl+d", "preview page down")),
	PageUp:        key.NewBinding(key.WithKeys("ctrl+u", "ctrl+k", "ctrl+p"), key.WithHelp("Ctrl+u", "preview page up")),
